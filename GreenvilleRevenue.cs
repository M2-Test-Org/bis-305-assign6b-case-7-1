...
class GreenvilleRevenue
{
   public static void Main()
   {
      ...
      int pos = 0;
      bool found;
//GetContestantNumber method refactor start
...
//GetContestantNumber method refactor end          
//Start the use the GetContestantNumber method refactor created above here 
...
//Stop the use of the GetContestantNumber method refactor created above here 
...
//DisplayRelationship refactor start
...
//DisplayRelationship refactor end
//GetContestantData refactor start
      x = 0;
      while(x < numThisYear)
      {
...
//GetContestantData refactor end
//GetLists refactor start
